...
foreach ($obt_marks as $key => $value) {
		...
		else
		{
			$query_for_marks = "INSERT INTO
		 	exam_marks(Test_Name,Sub_Name,Student_Name,Roll_No,Max_Marks,Obt_Marks,Class_Section,teacher_id)
			 VALUES('$Test_Name','$Sub_Name','$get_student_name','$get_roll_no','$Max_Marks','$get_obt_marks','$Class_Section','$teacher_id')";                          
